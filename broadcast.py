...
MESSAGES = {
    "ru": (
        ...
        "\n"
        "Теперь в рейтинге видно, как изменилась твоя позиция:\n"
        "↑ поднялся  •  ↓ опустился\n"
        "\n"
        "Следи за своим местом и поднимайся выше 🔥"
    ),

    "uk": (
        "🏆 <b>Оновлення рейтингу!</b>\n"
        "\n"
        "Тепер у рейтингу видно, як змінилася твоя позиція:\n"
        "↑ піднявся  •  ↓ опустився\n"
        "\n"
        "Стеж за своїм місцем і підіймайся вище 🔥"
    ),

    "en": (
        "🏆 <b>Leaderboard update!</b>\n"
        "\n"
        "You can now see how your position has changed:\n"
        "↑ moved up  •  ↓ moved down\n"
        "\n"
        "Track your rank and keep climbing 🔥"
    ),
}
